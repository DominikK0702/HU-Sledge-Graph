...
"}")
        ...
        self.headWidget.setMinimumSize(QtCore.QSize(0, 200))
        ...
        self.verticalLayout_5 = QtWidgets.QVBoxLayout(self.groupBox_Tools)
        ...
        self.verticalLayout_5.addLayout(self.verticalLayout_Tools)
